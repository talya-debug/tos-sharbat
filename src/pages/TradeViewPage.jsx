      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            >
              <span className="material-symbols-outlined text-[22px]">{trade.icon || 'build'}</span>
            </div>
            <h1 className="text-[18px] sm:text-[22px] font-bold text-gray-900 truncate">{tradeName}</h1>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              onClick={copyLink}
              id="copy-btn"
              className="w-9 h-9 rounded-full flex items-center justify-center text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-all"
              title="העתק לינק"
            >
            ...
            <button
              ...
              className="w-9 h-9 rounded-full flex items-center justify-center text-gray-500 hover:text-green-600 hover:bg-green-50 transition-all"
              title="שלח בוואטסאפ"
            >
